                                ...
                                <?php
                                    foreach ($tab as $category) {
                                        echo '<tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary"><a href="updatecategory.php?updatecatid='.$category['catid'].'" class="text-light">Update</a></button>
                                                <button class="btn btn-danger"><a href="deletecategory.php?deletecatid='.$category['catid'].'" class="text-light">Delete</a></button>
                                            </td>
                                        </tr>';
                                    }
                                ?>
