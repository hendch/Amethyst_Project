    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            ...
            <div class="header-menu">
                ...
                <div class="col-sm-5">
                    <div class="product-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="product-avatar rounded-circle" src="images/admin.jpg" alt="product Avatar">
                        </a>

                        <div class="product-menu dropdown-menu">
                            <a class="nav-link" href="#"><i class="fa fa-product"></i> My Profile</a>

                            <a class="nav-link" href="#"><i class="fa fa-product"></i> Notifications <span class="count">13</span></a>
