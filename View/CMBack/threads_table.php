    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            ...
            <div class="header-menu">
                ...
                <div class="col-sm-5">
                    <div class="MB-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <img class="MB-avatar rounded-circle" src="images/admin.jpg" alt="MB Avatar">
                        </a>

                        <div class="MB-menu dropdown-menu">
                            <a class="nav-link" href="#"><i class="fa fa-MB"></i> My Profile</a>

                            <a class="nav-link" href="#"><i class="fa fa-MB"></i> Notifications <span
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col"> <!-- Adjust the negative margin to reduce space -->
                            <a href="addMysteryBox.php" class="btn btn-success btn-lg btn-block">Create Mystery Box</a>
                        </div>
                    </div>
