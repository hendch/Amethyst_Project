...
if (
    ...
    if (
        ...
        // Create a new MYSTERYBOX object using the form data
        $mysteryBox = new MYSTERYBOX(
            $_POST['name'],
            floatval($_POST['price']), // Convert price to float
            $_POST['items'],
            intval($_POST['sold']), // Convert sold to integer
            $_POST['image']
        );

        // Create an instance of the MYSTERYBOXController
        $mysteryBoxController = new MYSTERYBOXController();
        // Assuming you have an 'addMYSTERYBOX' method in MYSTERYBOXController
        $mysteryBoxController->addMYSTERYBOX($mysteryBox);

        // Redirect to tables-data.php after adding the MYSTERYBOX
            ...
            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal"onsubmit="return validateForm()">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        ...
                        <small class="form-text text-muted">Input the name</small>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        ...
                        <small class="form-text text-muted">Input the price</small>
                    </div>
                </div>

                <div class="row form-group">
                    <div class="col col-md-3"><label for="items" class="form-control-label">Items</label></div>
                    <div class="col-12 col-md-9">
                        <input type="text" id="items" name="items" placeholder="Enter items" class="form-control">
                        <small class="form-text text-muted">Input the number of items</small>
                    </div>
                </div>

                <div class="row form-group">
                    <div class="col col-md-3"><label for="sold" class="form-control-label">Sold</label></div>
                    <div class="col-12 col-md-9">
                        <input type="text" id="sold" name="sold" placeholder="Enter sold" class="form-control">
                        <small class="form-text text-muted">Input the number of items sold</small>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="image" name="image" placeholder="Enter image path" class="form-control">
                        <small class="form-text text-muted">Input the number of items sold</small>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <button type="submit" href="tables-data.php" class="btn btn-primary">Submit</button>
                    </div>
                </div>
            </form>
        </div>
        <div class="row">
            <!-- Adjust the negative margin to reduce space -->
        </div>
    </div>
</div>
<script>
    function validateForm() {
        ...
        if (name === '' || price === '' || items === '' || sold === '' || image === '') {
        ...
        if (!pricePattern.test(price)) {
            alert('Please enter a valid price (only numbers allowed).');
            return false;
        }
        ...
        // Additional validations for other fields if required

        // Form submission will only occur if all validations pass
        return true;
    }
</script>
