<?php
    ...
    $category= $categoryC->showcategory($catid);
    $valid=0;
    if (isset($_POST["abbr"]) &&
        isset($_POST["catname"]) 
       ){
...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <form  method="post">
            ...
            <input type="text" id="abbr" name="abbr" value="<?php echo $category['abbr'] ;?>" >

            <br>

            <label for="catname">category name:</label>
            <input type="text" id="catname" name="catname" value ="<?php echo $category['catname'] ;?>" >
